...
class EmailOTP {
  ...
  static config({
    ...
    _appName = appName ?? "OTP_Generator";
    _appEmail = appEmail ?? "drshiran2003@gmail.com";
    ...
    try {
      ...
      if (response.statusCode == 200) {
        if (responseJson['status']) {
          ...
          debugPrint("OTP Sent to Email Successfully ✅️ ");
  ...
  static bool verifyOTP({required String otp}) {
    if (_otpResponse == otp) {
      debugPrint("OTP Validate Successfully ✅️ ");
